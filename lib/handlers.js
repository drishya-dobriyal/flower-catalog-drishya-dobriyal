...
const serveGuestPageComment = function (request, response) {
  const previousComments = fs.readFileSync(DATA_STORE, 'utf8');
...
const serveGuestPage = function (request, response) {
  const guestPage = fs.readFileSync(`${__dirname}/../templates/guestBooks.html`, 'utf8');
